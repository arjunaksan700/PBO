...
{
public:
    virtual bool OnInit(); // wxOVERRIDE; "Aku nggak tahu ini buat apa" -MLR
...
#define BOMBS_FONT wxFont(10, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, true)
